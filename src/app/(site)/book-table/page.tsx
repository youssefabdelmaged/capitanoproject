      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mt-12 text-center animate-slide-in-right">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-coffee-900 mb-4">Why Choose Capitano?</h3>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-coffee-900 mb-2">24/7 Service</h4>
                <p className="text-coffee-700 text-sm">Open around the clock for your convenience</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-coffee-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🏠</span>
                </div>
                <h4 className="font-semibold text-coffee-900 mb-2">Cozy Atmosphere</h4>
                <p className="text-coffee-700 text-sm">Warm and welcoming environment</p>
              </div>
            </div>
          </div>
        </div>
