      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden rounded-2xl">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 animate-fade-in">
            ...
            <span className="block text-4xl md:text-5xl mt-2 font-light">Coffee & Café</span>
          </h1>
          ...
          <div className="space-y-6 flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="max-w-lg text-center">
                <p className="text-lg text-coffee-800 leading-relaxed">
                  Founded in 2008, Capitano Coffee & Café has been serving the community 
                  for over 15 years with passion, dedication, and the finest coffee beans 
                  sourced from around the world. Our cozy atmosphere and friendly staff 
                  create the perfect environment for your morning coffee, business meetings, 
            ...
            <div className="flex flex-wrap gap-4 pt-4 justify-center">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-coffee-800 font-medium">Locally Sourced</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-coffee-600 rounded-full"></div>
                <span className="text-coffee-800 font-medium">Freshly Roasted</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-coffee-600 rounded-full"></div>
                <span className="text-coffee-800 font-medium">Cozy Atmosphere</span>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 px-4 md:px-8">
          {[
            ...
            },
            {
              ...
              description: "Our skilled baristas craft each drink with precision and passion.",
              icon: "👨‍🍳"
            },
            {
              title: "Cozy Environment",
              description: "A warm, welcoming space perfect for work, relaxation, or meeting friends.",
              icon: "🏠"
            }
          ].map((feature, index) => (
            <div
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="reviewer-name" className="block text-sm font-semibold text-coffee-900 mb-2">
                    Your Name *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="reviewer-email" className="block text-sm font-semibold text-coffee-900 mb-2">
                    Email Address *
                  </label>
                  <input
                    type="email"
              ...
              <div>
                ...
                <p className="text-sm text-coffee-600 mt-1">
                  {rating > 0 ? `You rated ${rating} star${rating > 1 ? 's' : ''}` : 'Click on a star to rate your experience'}
                </p>
              </div>

              <div>
                <label htmlFor="review-title" className="block text-sm font-semibold text-coffee-900 mb-2">
                  Review Title
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="review-text" className="block text-sm font-semibold text-coffee-900 mb-2">
                  Your Review *
                </label>
                <textarea
                  id="review-text"
        ...
        <div className="rounded-2xl bg-gradient-to-r from-coffee-800 to-coffee-900 text-white p-12 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-coffee-100/90 mb-8 max-w-2xl mx-auto">
              Join us for an unforgettable coffee experience. Book your table today 
